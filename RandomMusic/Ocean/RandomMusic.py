...
# --- 설정 값 ---
TOTAL_DURATION_MS = 5 * 60 * 1000  # 5분 (밀리초)
COLORS = ["Ocean_Color1", "Ocean_Color2", "Ocean_Color3"]
NUM_NOTES = 12
BASE_BPM = 140
PROBABILITIES = {
    "Ocean_Color1": 0.60,  # 60% 확률
    "Ocean_Color2": 0.20,  # 20% 확률
    "Ocean_Color3": 0.40   # 40% 확률
}
...
output.export("Ocean_R_1.wav", format="wav")
